...
function Scout69() {
    ...
    useEffect(() => {
        document.title = `Scout69 Videos page ${currentPage} on comxxx - bad wap wwwxxx xvedeo`;
        const metaDescContent = "Explore a collection of premium Scout69 Big boobs big dick videos on comxxx. Enjoy handpicked, high-quality content filtered for your preferences.";
        ...
        const canonicalUrl = `https://comxxx.fun/category/scout69/${currentPage === 1 ? '' : currentPage}`;
    ...
    return (
        <>
            <Helmet>
                <title>Scout69 Videos on comxxx - bad wap wwwxxx xvedeo</title>
                <link rel="canonical" href={`https://comxxx.fun/category/scout69/${currentPage === 1 ? '' : currentPage}`} /> {/* Dynamic canonical URL */}
                <meta name="description" content="Explore a collection of premium Scout69 Big boobs big dick videos on comxxx. Enjoy handpicked, high-quality content filtered for your preferences." />
            </Helmet>
